...
|------------|----------------|---------------|-----------|-------------|
| ![ER Diagram](screenshots/er_diagram.png) | ![Tables Created](screenshots/tables_created.png) | ![Products Data](screenshots/products_data.png) | ![Low Stock](screenshots/low_stock.png) | ![Top Selling](screenshots/top_selling.png) |

## ⚙️ How to Run
1. Install **MySQL Server 8.0+**.
2. Clone the repository and open your terminal or MySQL Workbench:
git clone https://github.com/Maheen.2307/ISMS.git
cd ISMS

text
3. Execute the full script using the MySQL command line (the script automatically handles `CREATE DATABASE` and `USE` directives):
mysql -u root -p < ISMS.sql

4. The script provisions the database, creates all 15 normalized tables, seeds sample data, sets up triggers/views, and executes all 15 analytical reporting queries.
